codeInput.plugins.Autocomplete = class extends codeInput.Plugin {
  ...
  updatePopup(a, b) {
    let c = a.querySelector("textarea"),
    ...
    (e.style.top = d.top + "px"),
      ...
      b || this.updatePopupCallback(e, c, c.selectionEnd);
  }
  afterElementsAdded(a) {
    ...
    let d = a.querySelector("textarea");
    d.addEventListener("keyup", this.updatePopup.bind(this, a, !1)),
      d.addEventListener("click", this.updatePopup.bind(this, a, !1)),
      d.addEventListener("scroll", this.updatePopup.bind(this, a, !0));
  }
